            ...
            try {
                ...
                auth.signInWithCredential(credential)
                    ...
                    .addOnFailureListener { exception ->
                        errorState.value = exception.message ?: "Google sign-in failed"
                        Log.e("GoogleLogin", "Google sign-in failed: ${exception.message}")
                    }
                    ...
                    loginManager.registerCallback(callbackManager, object : FacebookCallback<LoginResult> {
                        override fun onSuccess(loginResult: LoginResult) {
                            ...
                            auth.signInWithCredential(credential)
                                ...
                                .addOnFailureListener { exception ->
                                    errorState.value = exception.message ?: "Sign-in failed"
                                    Log.e("FacebookLogin", "Sign-in failed: ${exception.message}")
                                }
                        }

                        override fun onCancel() {
                            errorState.value = "Login cancelled by user"
                            Log.d("FacebookLogin", "Login cancelled by user")
                        }

                        override fun onError(exception: FacebookException) {
                            errorState.value = exception.message ?: "Facebook login error"
        ...
        .addOnCompleteListener { task ->
            if (task.isSuccessful) {
                ...
                if (user != null) {
                    ...
                    onSignInFailure("User data not found")
                }
            }
        }
